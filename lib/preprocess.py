...
# データ・モデルのベースディレクトリ（環境変数で上書き可能）
DATA_DIR = os.environ.get("TAE_DATA_DIR", r"C:\Users\kensei\dev\tae\data")
MODELS_DIR = os.environ.get("TAE_MODELS_DIR", r"C:\Users\kensei\dev\tae\models")
